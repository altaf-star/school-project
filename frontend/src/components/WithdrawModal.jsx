    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6 z-10">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-bold text-gray-900">Withdraw Student</h2>
        ...
        <p className="text-sm text-gray-500 mb-6">
          Mark <span className="font-semibold text-gray-700">{student.name}</span> ({student.admissionNumber}) as withdrawn.
        </p>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Withdrawal Class</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Withdrawal Date</label>
            <input
              type="date"
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                form.slcIssued ? 'bg-blue-600' : 'bg-gray-300'
              }`}
            >
              <span
            ...
            <label className="text-sm font-medium text-gray-700">SLC Issued</label>
          </div>
